...
var google=companies.find(
    (comp)=>comp.name== "Google"
)
...
var fbEmployees = companies.find(
    (comp) => comp.name == "Facebook"
).employees;

console.log(fbEmployees);

var microsofFounders=companies.find(
    (com)=>com.name=="Microsoft"
).employees.filter(
    (emp)=> emp.post == "founder" 
);
